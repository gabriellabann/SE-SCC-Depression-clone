...
#\| label: writing results into .csv #\| echo: FALSE

```{r}
write_csv(wave1_cohort1_clean, "Wave1_Cohort1_Scored_Measures.csv")
```

#\| label: descriptive statistics #\| echo: FALSE

```{r}
summary(wave1_cohort1_clean$CESD_Total)
```

#\| label: summary of measures #\| echo: FALSE
