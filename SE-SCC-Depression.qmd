...
The mean CES-D score was

```         
`r mean(wave1_cohort1_clean$CESD_Total, na.rm = TRUE)`
```
...
#| label: loading data 
#| echo: FALSE 
library(readr) wave1_cohort1_clean <- read_csv("Wave1_Cohort1_Scored_Measures.csv")
```
